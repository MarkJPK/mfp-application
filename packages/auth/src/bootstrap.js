...
//  The local index.html file which definitely has an element with an id of '_auth-dev-root'
...
//  There is not guarantee that an element with an id of '_auth-dev-root' exists
